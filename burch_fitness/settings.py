...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-r^cw404wxoxzth)%+pb371a$g$dsy1(7hzt#o@__w1b3)kj9a6')
...
ROOT_URLCONF = 'burch_fitness.urls'
...
WSGI_APPLICATION = 'burch_fitness.wsgi.application'
